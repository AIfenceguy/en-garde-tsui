...
import { mountLegend } from './modules/legend.js';
import { mountTutorial } from './modules/tutorial.js';
...
defineRoute('insight', mountInsight);
defineRoute('season', mountSeason);
defineRoute('settings', mountSettings);
defineRoute('legend', mountLegend);
defineRoute('tutorial', mountTutorial);
